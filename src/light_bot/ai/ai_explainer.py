...
Приклад гарної відповіді: "Вечірнє відключення подовжено на 2 години - тепер світло буде вимкнено до 20:00 замість 18:00. Ранкові відключення залишились без змін."

Відповідь (лише текст пояснення, без додаткового форматування):"""
